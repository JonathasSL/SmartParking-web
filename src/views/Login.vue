			...
			<form v-else class="form-register-parking" @submit.prevent="register">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-3">
						...
						<input v-model.number="formRegister.parking.price_per_hour" type="number" id="price_per_hour" class="form-control" placeholder="2,00">
					</div>
					<div class="form-group col-md-3">
						<label for="amount_parking_spots">Total de vagas:</label>
						<input v-model.number="formRegister.parking.amount_parking_spots" type="number" id="amount_parking_spots" class="form-control" placeholder="30">
					</div>
				</div>				
